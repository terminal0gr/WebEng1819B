	...
	<?php
		...
		if (isset($_POST['submit'])) {
			...
			if($code == 400) {
				...
				?>
				<tr><th rowspan=2 align=center>Διάρκεια</th>
					<th colspan=2>Αναχώρηση</th>
					<th colspan=2 align=center>Άφιξη</th>
					<th colspan=3 align=center>Πτήση</th>
					<th colspan=2 rowspan=2 align=center>Θέση</th>
					<th rowspan=2 align=center>Διαθέσιμες<br>θέσεις</th>
					<th colspan=3 align=center>Συν. Κόστος</th>
				</tr>
				<tr><th align=center>Αεροδρόμιο</th>
					<th align=center>Ώρα</th>
					<th align=center>Αεροδρόμιο</th>
					<th align=center>Ώρα</th>
					<th align=center>Airline</th>
					<th align=center>Αριθμός</th>
					<th align=center>Αεροσκάφος</th>
					<th align=center>Total Price</th>
					<th align=center>Total Fare</th>
